...
public class MainFrame extends JFrame{
	...
	{ 
		...
		{ 
			...
			out.println("Results of tabulating a polynomial according to Horner's scheme"); 
			out.print("Polynom: "); 
			...
			out.println("Interval from " + data.getFrom() + " to " + 
					data.getTo() + " step is " + data.getStep()); 
			out.println("====================================================");
			for (int i = 0; i<data.getRowCount(); i++)
				{ 
					out.println("Value in point " + formatter.format(data.getValueAt(i,0)) 
							+ " is " + formatter.format(data.getValueAt(i,1))); 
				} 
			out.close();     
		} 
